...
const Portfolio = () => {
  return (
    <div className="bg-gray-100 rounded p-10">
      ...
      <p className="mt-5">
        <span className="font-bold">Email: </span> abulhasanat902@gmail.com
      </p>
      <p className="my-5">
        <span className="font-bold">Education: </span>B.Sc in Computer Science
        and Engineering
      </p>
      ...
      <p className="text-blue-400">
        1- https://warehouse-management-cli-9103e.web.app/
      </p>
      <p className="text-blue-400">
        2- https://independent-service-prov-5cd6e.web.app/
      </p>
      <p className="text-blue-400">
        3- https://analysis-product-has.netlify.app/
      </p>
    </div>
  );
};
